/*
package com.example.asus.jogomemoria;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mudar a cor do segundo jogador inativo
    ...
    private void doStuff(ImageView iv, int card) {
        ...
        //manda a imagem correta para a imageview
        ...
        //verifica a imagem selecionada e guarda-a temporariamente
        if (cardNumber == 1) {
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //vê se as duas imagens são iguais
                    igual();
                }
            }, 1000);
        }
    ...
    private void igual() {
        ...
        //caso sejam iguais torna as imagens invisiveis
        ...
        //caso as cartas não sejam iguais "esconde" novamente a carta
        else {
